...
const sv=await po('app.oilssense.com','/api/apps/'+APP+'/entities/LabAnalysis',UT,{h2:data.h2,ch4:data.ch4,c2h2:data.c2h2,c2h4:data.c2h4,c2h6:data.c2h6,co:data.co,co2:data.co2,furfural:data.furfural,data_coleta:data.data_coleta,laboratorio:data.laboratorio,numero_laudo:data.numero_laudo,transformer_id:tid,subscription_id:SI,tipo_oleo:data.tipo_oleo||"Mineral"});
